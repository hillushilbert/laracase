...
EOD;
     ...
     * @return $this
     */
    protected function replaceTimestamps(&$stub, $replaceTimestamps)
    {
        if ($replaceTimestamps == 'yes') {
            $stub = str_replace('{{timestamps}}', "", $stub);
        } else {
            $stub = str_replace('{{timestamps}}', "public \$timestamps = false;\n	", $stub);
        }
